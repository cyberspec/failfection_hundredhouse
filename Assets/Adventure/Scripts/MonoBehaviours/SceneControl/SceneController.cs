...
public class SceneController : MonoBehaviour
{
    ...
    public bool allowLoadScene = true; // arif: we need to stop auto loading
    ...
    private IEnumerator Start ()
    {
        ...
        if(allowLoadScene) yield return StartCoroutine (LoadSceneAndSetActive (startingSceneName));
